...
const Brand = () => {
    ...
    return (
        <div className='my-8'>
            ...
            <h2 className='text-4xl text-[#5EA3CA] text-center font-bold mb-8'>Products</h2>

            <div className='max-w-7xl mx-auto grid md:grid-cols-2 gap-6 px-6 md:px-0'>
                {
                    // products.map(product => <ShowProduct key={product._id} product={product}></ShowProduct>)
                    ...
                    products.length > 0 ?
                        ...
                        :
                        <>
                            <h2 className='text-3xl font-bold text-center my-10 bg-slate-200 p-6 rounded-lg'>
                                There is no products available of this brand!
                            </h2>
                        </>
                }
            </div>
